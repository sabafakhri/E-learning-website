    ...
    <div className="text-background dark:text-foreground font-metropolis flex flex-col items-center justify-center gap-3.75 bg-gray-900 text-center max-sm:px-5 max-sm:py-10 sm:h-105 sm:gap-5">
      ...
      <div>
        ...
        <div className="sm:focus-within:ring-ring/50 sm:focus-within:ring-offset-background mx-2.5 flex transition-all duration-300 max-sm:flex-col max-sm:gap-5 sm:focus-within:ring-[3px] lg:rounded-[10px]">
          <Input
            className="peer text-14-30 lg:text-16-30 placeholder:text-background dark:placeholder:text-foreground h-12.5 rounded-[5px] border-none bg-white/20 font-medium sm:rounded-r-none sm:focus-visible:border-none sm:focus-visible:ring-0 lg:h-15 lg:rounded-[10px]"
